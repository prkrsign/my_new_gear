class Scraping
  ...
  def self.get_product(link)
    ...
    gearname = gearname.gsub(/(BOSS|MXR|Electro-Harmonix|tc electronic|BEHRINGER|Ibanez)|【.+|\(.+|《.+|即.+|☆.+|\[.+/, '')
    ...
    gear = Gear.where(gearname: gearname).first_or_initialize
    gear.image = image
    gear.maker = maker
